...
public class CommandHandler implements CommandExecutor {
    ...
    public @interface CodCommand {
        ...
        boolean mustHaveAgreedToTerms() default false;
    }
    ...
    private void handleCommand(CommandSender sender, CodCommand meta, String[] args) {
        try {
            ...
            if (meta.mustHaveAgreedToTerms() && TextPlayer.findUser(sender.getName()) == null) {
                sender.sendMessage("§4You must first agree to the Terms of Use by typing §2/text agree");
                sender.sendMessage("§bThe Terms are listed below and at §2www.codisimus.com/terms");
                sender.sendMessage("§5The author of this plugin is not responsible for any of the following:");
                sender.sendMessage("§21. §bCharges which may occur through sending/receiving text messages");
                sender.sendMessage("§22. §bPhone numbers or email addresses becoming public");
                sender.sendMessage("§23. §bText messages spamming a phone due to glitches in the program or for any other reason");
                return;
            }
