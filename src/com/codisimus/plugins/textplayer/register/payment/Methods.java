package com.codisimus.plugins.textplayer.register.payment;
...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new com.codisimus.plugins.textplayer.register.payment.methods.iCo6());
        addMethod("iConomy", new com.codisimus.plugins.textplayer.register.payment.methods.iCo5());
        addMethod("iConomy", new com.codisimus.plugins.textplayer.register.payment.methods.iCo4());
        addMethod("BOSEconomy", new com.codisimus.plugins.textplayer.register.payment.methods.BOSE6());
        addMethod("BOSEconomy", new com.codisimus.plugins.textplayer.register.payment.methods.BOSE7());
        addMethod("Essentials", new com.codisimus.plugins.textplayer.register.payment.methods.EE17());
        addMethod("Currency", new com.codisimus.plugins.textplayer.register.payment.methods.MCUR());
        addMethod("3co", new com.codisimus.plugins.textplayer.register.payment.methods.ECO3());
